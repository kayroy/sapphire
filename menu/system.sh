...
;;
77)
wget https://raw.githubusercontent.com/kayroy/Vergil/main2/addons/dns2.sh && chmod +x dns2.sh && ./dns2.sh
;;
88)
wget https://raw.githubusercontent.com/kayroy/Vergil/main/Tunnel/udp.sh && bash udp.sh
;;
99)
